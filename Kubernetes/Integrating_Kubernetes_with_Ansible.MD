...
1. Create ansible playbooks to create **[deployment](https://github.com/aajibad1/Simple-DevOps-Project/blob/master/Kubernetes/kubernetes-valaxy-deployment.yml)** and **[services](https://github.com/aajibad1/Simple-DevOps-Project/blob/master/Kubernetes/kubernetes-valaxy-service.yml)** 
